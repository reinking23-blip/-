...
const MAPPINGS: MappingEntry[] = [
  ...
  { category: 'Product Info', variableKey: 'productId', inputLocation: '封面 Cover', description: 'Product Catalog Number', uiLabel: '2.2 溶液配制 L (CN)', location: 'Val Proc Linearity', context: '取 [productId] 对照品约 ... mg', example: 'HY130225' },
  { category: 'Product Info', variableKey: 'productId', inputLocation: '封面 Cover', description: 'Product Catalog Number', uiLabel: '2.2 溶液配制 L (EN)', location: 'Val Proc Linearity', context: 'mg of [productId] reference standard ...', example: 'HY130225' },
  ...
  { category: 'Product Info', variableKey: 'protocolCode', inputLocation: '封面 Cover', description: 'Protocol Series Code', uiLabel: '方法编号 (Middle)', location: '4.2 Instruments', context: 'Method name: TM-[protocolCode]-LC-...', example: 'A316' },
  ...
  { category: 'Product Info', variableKey: 'protocolVersion', inputLocation: '封面 Cover', description: 'Protocol Version', uiLabel: '方法编号 (Suffix)', location: '4.2 Instruments', context: 'Method name: ...-LC-[protocolVersion].00', example: '02' },

  { category: 'Product Info', variableKey: 'projectNumber', inputLocation: 'App Config (Code)', description: 'Project Iteration Number', uiLabel: '方案号 (Suffix 2)', location: 'Cover', context: 'Protocol #: ...-[protocolVersion].[projectNumber]', example: '00' },
  { category: 'Product Info', variableKey: 'projectNumber', inputLocation: 'App Config (Code)', description: 'Project Iteration Number', uiLabel: '方案号 (Suffix 2)', location: 'ProtocolHeader', context: 'Header Protocol #: ...-[protocolVersion].[projectNumber]', example: '00' },
  { category: 'Product Info', variableKey: 'projectNumber', inputLocation: 'App Config (Code)', description: 'Project Iteration Number', uiLabel: '方法编号 (Suffix 2)', location: '4.2 Instruments', context: 'Method name: ...-LC-[protocolVersion].[projectNumber]', example: '00' },
  ...
  { category: 'Testing Conditions', variableKey: 'testingConditions[i].labelZh', inputLocation: '4. 检验方法描述 - 4.2 仪器及检测条件', description: 'Custom Condition Label (CN)', uiLabel: '自定义条件标签 (中)', location: '4.2 Instruments', context: '[labelZh]: [value]', example: '自定义参数' },
  { category: 'Testing Conditions', variableKey: 'testingConditions[i].labelEn', inputLocation: '4. 检验方法描述 - 4.2 仪器及检测条件', description: 'Custom Condition Label (EN)', uiLabel: 'Custom Condition Label (EN)', location: '4.2 Instruments', context: '[labelEn]: [value]', example: 'Custom Parameter' },
  { category: 'Testing Conditions', variableKey: 'testingConditions[i].value', inputLocation: '4. 检验方法描述 - 4.2 仪器及检测条件', description: 'Custom Condition Value', uiLabel: '自定义条件值', location: '4.2 Instruments', context: '[labelZh]: [value]', example: '...' },

  { category: 'Gradient Table', variableKey: 'gradientData[i].time', inputLocation: '4. 检验方法描述 - 4.2 仪器及检测条件', description: 'Gradient Time Point', uiLabel: '梯度时间', location: '4.2 Instruments', context: 'Time: [time]', example: '0.0' },
  { category: 'Gradient Table', variableKey: 'gradientData[i].phaseA', inputLocation: '4. 检验方法描述 - 4.2 仪器及检测条件', description: 'Gradient Phase A', uiLabel: '流动相A比例', location: '4.2 Instruments', context: 'Phase A: [phaseA]%', example: '80' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splWeight', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Weight', uiLabel: 'Sample Weight (EN)', location: '4.3 Solution Prep', context: 'Accurately weigh about [splWeight] mg', example: '20' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splWeight', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Weight', uiLabel: 'Sample Weight (EN)', location: 'Val Proc Specificity', context: 'Accurately weigh about [splWeight] mg', example: '20' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splWeight', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Weight', uiLabel: 'Sample Weight (EN)', location: 'Val Proc Precision', context: 'Accurately weigh about [splWeight] mg', example: '20' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splVolume', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Volume', uiLabel: 'Sample Volume (EN)', location: '4.3 Solution Prep', context: 'into a [splVolume] ml volumetric flask', example: '100' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splVolume', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Volume', uiLabel: 'Sample Volume (EN)', location: 'Val Proc Specificity', context: 'into a [splVolume] ml volumetric flask', example: '100' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splVolume', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Volume', uiLabel: 'Sample Volume (EN)', location: 'Val Proc Precision', context: 'into a [splVolume] ml volumetric flask', example: '100' },
  ...
  { category: 'Solution Detail', variableKey: 'solDetail.splCount', inputLocation: '4. 检验方法描述 - 4.3 溶液配制', description: 'Sample Prep Count', uiLabel: 'Sample Prep Count (EN)', location: '4.3 Solution Prep', context: 'Prepare [splCount] solutions', example: '2' },
  ...
  // ==================================================================================
  { category: 'System Suitability', variableKey: 'sysSuitability.plateNumber', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Plate Number', uiLabel: '理论板数 (CN)', location: '4.5 Sys Suit', context: '主峰理论板数应不低于 [plateNumber]', example: '5000' },
  { category: 'System Suitability', variableKey: 'sysSuitability.plateNumber', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Plate Number', uiLabel: 'Plate Number (EN)', location: '4.5 Sys Suit', context: 'theoretical plate number ... should be not less than [plateNumber]', example: '5000' },
  { category: 'System Suitability', variableKey: 'sysSuitability.plateNumber', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Plate Number', uiLabel: '理论板数 (6.1)', location: '6.1 System Suitability', context: '主峰理论板数应不低于 [plateNumber]', example: '5000' },
  { category: 'System Suitability', variableKey: 'sysSuitability.plateNumber', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Plate Number', uiLabel: 'Plate Number (6.1)', location: '6.1 System Suitability', context: 'theoretical plate number ... should be not less than [plateNumber]', example: '5000' },

  { category: 'System Suitability', variableKey: 'sysSuitability.tailingFactor', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Tailing Factor', uiLabel: '拖尾因子 (CN)', location: '4.5 Sys Suit', context: '拖尾因子应不大于 [tailingFactor]', example: '2.5' },
  { category: 'System Suitability', variableKey: 'sysSuitability.tailingFactor', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Tailing Factor', uiLabel: 'Tailing Factor (EN)', location: '4.5 Sys Suit', context: 'trailing factor should not be more than [tailingFactor]', example: '2.5' },
  { category: 'System Suitability', variableKey: 'sysSuitability.tailingFactor', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Tailing Factor', uiLabel: '拖尾因子 (6.1)', location: '6.1 System Suitability', context: '拖尾因子应不大于 [tailingFactor]', example: '2.5' },
  { category: 'System Suitability', variableKey: 'sysSuitability.tailingFactor', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Tailing Factor', uiLabel: 'Tailing Factor (6.1)', location: '6.1 System Suitability', context: 'trailing factor should not be more than [tailingFactor]', example: '2.5' },

  { category: 'System Suitability', variableKey: 'sysSuitability.injectionCount', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Injection Count (RSD)', uiLabel: 'RSD进样针数 (CN)', location: '4.5 Sys Suit', context: '连续进样 [injectionCount] 针', example: '5' },
  { category: 'System Suitability', variableKey: 'sysSuitability.injectionCount', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Injection Count (RSD)', uiLabel: 'Injection Count (EN)', location: '4.5 Sys Suit', context: 'For [injectionCount] consecutive standard solution1', example: '5' },
  { category: 'System Suitability', variableKey: 'sysSuitability.injectionCount', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Injection Count (RSD)', uiLabel: 'RSD进样针数 (6.1)', location: '6.1 System Suitability', context: '连续进样 [injectionCount] 针', example: '5' },
  { category: 'System Suitability', variableKey: 'sysSuitability.injectionCount', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Injection Count (RSD)', uiLabel: 'Injection Count (6.1)', location: '6.1 System Suitability', context: 'For [injectionCount] consecutive standard solution1', example: '5' },

  { category: 'System Suitability', variableKey: 'sysSuitability.areaRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Area RSD Limit', uiLabel: '面积 RSD (CN)', location: '4.5 Sys Suit', context: '峰面积的RSD应≤ [areaRSD] %', example: '2.0' },
  { category: 'System Suitability', variableKey: 'sysSuitability.areaRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Area RSD Limit', uiLabel: 'Area RSD (EN)', location: '4.5 Sys Suit', context: 'RSD of the main peak area should be NMT [areaRSD] %', example: '2.0' },
  { category: 'System Suitability', variableKey: 'sysSuitability.areaRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Area RSD Limit', uiLabel: '面积 RSD (6.1)', location: '6.1 System Suitability', context: '峰面积的RSD应≤ [areaRSD] %', example: '2.0' },
  { category: 'System Suitability', variableKey: 'sysSuitability.areaRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Area RSD Limit', uiLabel: 'Area RSD (6.1)', location: '6.1 System Suitability', context: 'RSD of the main peak area should be NMT [areaRSD] %', example: '2.0' },

  { category: 'System Suitability', variableKey: 'sysSuitability.retentionRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Retention RSD Limit', uiLabel: '保留时间 RSD (CN)', location: '4.5 Sys Suit', context: '保留时间的RSD应≤ [retentionRSD] %', example: '1.0' },
  { category: 'System Suitability', variableKey: 'sysSuitability.retentionRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Retention RSD Limit', uiLabel: 'Retention RSD (EN)', location: '4.5 Sys Suit', context: 'RSD of the retention time should be NMT [retentionRSD] %', example: '1.0' },
  { category: 'System Suitability', variableKey: 'sysSuitability.retentionRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Retention RSD Limit', uiLabel: '保留时间 RSD (6.1)', location: '6.1 System Suitability', context: '保留时间的RSD应≤ [retentionRSD] %', example: '1.0' },
  { category: 'System Suitability', variableKey: 'sysSuitability.retentionRSD', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Retention RSD Limit', uiLabel: 'Retention RSD (6.1)', location: '6.1 System Suitability', context: 'RSD of the retention time should be NMT [retentionRSD] %', example: '1.0' },

  { category: 'System Suitability', variableKey: 'sysSuitability.recoveryRange', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Recovery Range', uiLabel: '回收率范围 (CN)', location: '4.5 Sys Suit', context: '回收率在 [recoveryRange] 之间', example: '98.0%~102.0%' },
  { category: 'System Suitability', variableKey: 'sysSuitability.recoveryRange', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Recovery Range', uiLabel: 'Recovery Range (EN)', location: '4.5 Sys Suit', context: 'recovery ... was between [recoveryRange]', example: '98.0%~102.0%' },
  { category: 'System Suitability', variableKey: 'sysSuitability.recoveryRange', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Recovery Range', uiLabel: '回收率范围 (6.1)', location: '6.1 System Suitability', context: '回收率在 [recoveryRange] 之间', example: '98.0%~102.0%' },
  { category: 'System Suitability', variableKey: 'sysSuitability.recoveryRange', inputLocation: '4. 检验方法描述 - 4.5 系统适用性要求', description: 'Recovery Range', uiLabel: 'Recovery Range (6.1)', location: '6.1 System Suitability', context: 'recovery ... was between [recoveryRange]', example: '98.0%~102.0%' },
  ...
  // ==================================================================================
  // 4.7 CALCULATION OPTIONS
  // ==================================================================================
  { category: 'Calculation', variableKey: 'calculationState.kf', inputLocation: '4. 检验方法描述 - 4.7 计算', description: 'Correction: KF', uiLabel: '水分校正', location: '4.7 Calculation', context: 'Correction: KF', example: 'true' },
  { category: 'Calculation', variableKey: 'calculationState.lod', inputLocation: '4. 检验方法描述 - 4.7 计算', description: 'Correction: LOD', uiLabel: '干燥失重校正', location: '4.7 Calculation', context: 'Correction: LOD', example: 'false' },
  { category: 'Calculation', variableKey: 'calculationState.sr', inputLocation: '4. 检验方法描述 - 4.7 计算', description: 'Correction: SR', uiLabel: '溶剂残留校正', location: '4.7 Calculation', context: 'Correction: SR', example: 'false' },
  { category: 'Calculation', variableKey: 'calculationState.tga', inputLocation: '4. 检验方法描述 - 4.7 计算', description: 'Correction: TGA', uiLabel: 'TGA校正', location: '4.7 Calculation', context: 'Correction: TGA', example: 'false' },
  ...
  // ==================================================================================
  // Specificity
  { category: 'Validation Params', variableKey: 'specificityState.retentionDevLimit', inputLocation: '6. 验证内容 - 6.x 专属性', description: 'Retention Deviation', uiLabel: '保留时间偏差限度 (CN)', location: '6.x Specificity', context: '保留时间相对偏差应不大于 [retentionDevLimit] %', example: '5.0' },
  { category: 'Validation Params', variableKey: 'specificityState.retentionDevLimit', inputLocation: '6. 验证内容 - 6.x 专属性', description: 'Retention Deviation', uiLabel: 'Retention Deviation (EN)', location: '6.x Specificity', context: 'relative deviation of the retention time should be not more than [retentionDevLimit] %', example: '5.0' },
  { category: 'Validation Params', variableKey: 'specificityState.retentionDevLimit', inputLocation: '6. 验证内容 - 6.x 专属性', description: 'Retention Deviation', uiLabel: '保留时间偏差限度 (CN)', location: 'Val Proc Specificity (Acc)', context: '保留时间相对偏差应不大于 [retentionDevLimit] %', example: '5.0' },
  { category: 'Validation Params', variableKey: 'specificityState.retentionDevLimit', inputLocation: '6. 验证内容 - 6.x 专属性', description: 'Retention Deviation', uiLabel: 'Retention Deviation (EN)', location: 'Val Proc Specificity (Acc)', context: 'relative deviation of the retention time should be not more than [retentionDevLimit] %', example: '5.0' },
  ...
  // Accuracy
  { category: 'Validation Params', variableKey: 'accuracyState.recoveryRange', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy Recovery', uiLabel: '准确度回收率范围 (CN)', location: '6.x Accuracy', context: '回收率均应在 [recoveryRange] 范围内', example: '98.0%-102.0%' },
  { category: 'Validation Params', variableKey: 'accuracyState.recoveryRange', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy Recovery', uiLabel: 'Accuracy Recovery (EN)', location: '6.x Accuracy', context: 'recovery ... should be in the range of [recoveryRange]', example: '98.0%-102.0%' },
  { category: 'Validation Params', variableKey: 'accuracyState.recoveryRange', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy Recovery', uiLabel: '准确度回收率范围 (CN)', location: 'Val Proc Accuracy (Acc)', context: '回收率均应在 [recoveryRange] 范围内', example: '98.0%-102.0%' },
  { category: 'Validation Params', variableKey: 'accuracyState.recoveryRange', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy Recovery', uiLabel: 'Accuracy Recovery (EN)', location: 'Val Proc Accuracy (Acc)', context: 'recovery ... should be within the range of [recoveryRange]', example: '98.0%-102.0%' },

  { category: 'Validation Params', variableKey: 'accuracyState.rsdLimit', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy RSD', uiLabel: '准确度RSD限度 (CN)', location: '6.x Accuracy', context: 'RSD≤ [rsdLimit]', example: '2.0%' },
  { category: 'Validation Params', variableKey: 'accuracyState.rsdLimit', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy RSD', uiLabel: 'Accuracy RSD (EN)', location: '6.x Accuracy', context: 'RSD≤ [rsdLimit]', example: '2.0%' },
  { category: 'Validation Params', variableKey: 'accuracyState.rsdLimit', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy RSD', uiLabel: '准确度RSD限度 (CN)', location: 'Val Proc Accuracy (Acc)', context: 'RSD≤ [rsdLimit]', example: '2.0%' },
  { category: 'Validation Params', variableKey: 'accuracyState.rsdLimit', inputLocation: '6. 验证内容 - 6.x 准确度', description: 'Accuracy RSD', uiLabel: 'Accuracy RSD (EN)', location: 'Val Proc Accuracy (Acc)', context: 'RSD≤ [rsdLimit]', example: '2.0%' },

  // Stability
  { category: 'Validation Params', variableKey: 'stabilityState.sampleTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Sample Temp', uiLabel: '稳定性供试品温度 (CN)', location: '6.x Stability', context: '供试品溶液 [sampleTemp] ℃条件下', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.sampleTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Sample Temp', uiLabel: 'Stability Sample Temp (EN)', location: '6.x Stability', context: 'Sample solution: ... at [sampleTemp] ℃', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.sampleTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: '稳定性供试品温度 (CN)', uiLabel: '稳定性供试品温度 (CN)', location: 'Val Proc Stability (Acc)', context: '供试品溶液 [sampleTemp] ℃条件下', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.sampleTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Sample Temp', uiLabel: 'Stability Sample Temp (EN)', location: 'Val Proc Stability (Acc)', context: 'Sample solution: ... at [sampleTemp] ℃', example: '5±3' },
  ...
  { category: 'Validation Params', variableKey: 'stabilityState.standardTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Standard Temp', uiLabel: 'Stability Standard Temp (EN)', location: '6.x Stability', context: 'Standard solution: ... at [standardTemp] ℃', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: '稳定性对照品温度 (CN)', uiLabel: '稳定性对照品温度 (CN)', location: 'Val Proc Stability (Obj)', context: '对照品溶液...在 [standardTemp] ℃条件下', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Standard Temp', uiLabel: 'Stability Standard Temp (EN)', location: 'Val Proc Stability (Obj)', context: 'stored under at [standardTemp] ℃', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: '稳定性对照品温度 (CN)', uiLabel: '稳定性对照品温度 (CN)', location: 'Val Proc Stability (Acc)', context: '对照品溶液...在 [standardTemp] ℃条件下', example: '5±3' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardTemp', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Standard Temp', uiLabel: 'Stability Standard Temp (EN)', location: 'Val Proc Stability (Acc)', context: 'Standard solution: ... at [standardTemp] ℃', example: '5±3' },

  { category: 'Validation Params', variableKey: 'stabilityState.standardRecovery', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Standard Rec', uiLabel: '稳定性对照品回收率 (CN)', location: '6.x Stability', context: '回收率应在 [standardRecovery] 之间', example: '98.0%~102.0%' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardRecovery', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Standard Rec', uiLabel: 'Stability Standard Rec (EN)', location: '6.x Stability', context: 'recovery ... should be [standardRecovery]', example: '98.0%~102.0%' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardRecovery', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: '稳定性对照品回收率 (CN)', uiLabel: '稳定性对照品回收率 (CN)', location: 'Val Proc Stability (Acc)', context: '回收率应在 [standardRecovery] 之间', example: '98.0%~102.0%' },
  { category: 'Validation Params', variableKey: 'stabilityState.standardRecovery', inputLocation: '6. 验证内容 - 6.x 溶液稳定性', description: 'Stability Standard Rec', uiLabel: 'Stability Standard Rec (EN)', location: 'Val Proc Stability (Acc)', context: 'recovery ... should be [standardRecovery]', example: '98.0%~102.0%' },
  ...
  { category: 'Linearity', variableKey: 'linearityState.solutions[i].weight', inputLocation: '验证步骤 - (三) 线性和范围', description: 'Linearity Weight', uiLabel: '线性称样量', location: 'Val Proc Linearity', context: '取对照品约 [weight] mg', example: '16' },
  { category: 'Linearity', variableKey: 'linearityState.solutions[i].volume', inputLocation: '验证步骤 - (三) 线性和范围', description: 'Linearity Volume', uiLabel: '线性定容体积', location: 'Val Proc Linearity', context: '置 [volume] ml 量瓶中', example: '100' },
